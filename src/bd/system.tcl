...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.C_S_AXI_ACLK_FREQ_HZ {102000000} \
 ] $axi_uartlite_0
  ...
  # Create instance: rst_ps7_1_100M, and set properties
  set rst_ps7_1_100M [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_1_100M ]
  ...
  connect_bd_intf_net -intf_net ps7_1_axi_periph_M03_AXI [get_bd_intf_pins axi_uartlite_0/S_AXI] [get_bd_intf_pins ps7_1_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net axi_uartlite_0_interrupt [get_bd_pins axi_uartlite_0/interrupt] [get_bd_pins processing_system7_1/IRQ_F2P]
  connect_bd_net -net processing_system7_1_FCLK_CLK0 [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins processing_system7_1/FCLK_CLK0] [get_bd_pins processing_system7_1/M_AXI_GP0_ACLK] [get_bd_pins ps7_1_axi_periph/ACLK] [get_bd_pins ps7_1_axi_periph/M00_ACLK] [get_bd_pins ps7_1_axi_periph/M01_ACLK] [get_bd_pins ps7_1_axi_periph/M02_ACLK] [get_bd_pins ps7_1_axi_periph/M03_ACLK] [get_bd_pins ps7_1_axi_periph/M04_ACLK] [get_bd_pins ps7_1_axi_periph/M05_ACLK] [get_bd_pins ps7_1_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_1_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_1_FCLK_RESET0_N [get_bd_pins processing_system7_1/FCLK_RESET0_N] [get_bd_pins rst_ps7_1_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_1_100M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins ps7_1_axi_periph/ARESETN] [get_bd_pins ps7_1_axi_periph/M00_ARESETN] [get_bd_pins ps7_1_axi_periph/M01_ARESETN] [get_bd_pins ps7_1_axi_periph/M02_ARESETN] [get_bd_pins ps7_1_axi_periph/M03_ARESETN] [get_bd_pins ps7_1_axi_periph/M04_ARESETN] [get_bd_pins ps7_1_axi_periph/M05_ARESETN] [get_bd_pins ps7_1_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_1_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_ports USB_PULLUP] [get_bd_pins xlconstant_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x42C00000 [get_bd_addr_spaces processing_system7_1/Data] [get_bd_addr_segs axi_uartlite_0/S_AXI/Reg] SEG_axi_uartlite_0_Reg
